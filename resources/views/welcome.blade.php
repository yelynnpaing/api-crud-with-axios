                    ...
                    <div class="modal-body">
                        <form id="editModalForm">
                            ...
                            <div class=" form-group mb-4">
                                ...
                                <textarea rows="5" class="form-control" name="description" id="modalDescription"></textarea>
             ...
             .then(response => {
                ...
                response.data.forEach(item => {
                    tBody.innerHTML += '<tr>'+
                                            ...
                                            '<td>'+
                                                '<button class="btn btn-primary btn-sm me-3" data-bs-toggle="modal" data-bs-target="#modalForm" onclick="editModalBtn('+item.id+')">Edit</button>'+
                ...
                axios.post('/api/posts', {
                    ...
                    .then(response => {
                        ...
                        if(response.data.msg == 'New Item created successful.'){
                            successMsg.innerHTML =  '<div class="alert alert-success alert-dismissible fade show" role="alert">'+
                                                        '<div class="">'+response.data.msg+'</div>'+
                            ...
                            // console.log(response.data.msg.title);
                            // console.log(titleErr);
                            //ANOTHER WAY
                            // if(title.value == ''){
                            //     titleErr.innerText = response.data.msg.title['0']
                            // }else{
                            //     titleErr.innerText = '';
                            // }
            ...
            function editModalBtn(itemId){
                ...
                axios.get('/api/posts/'+itemId)
                     .then(response => {
                        ...
                        modalDescription.value = response.data.description;
                     })
